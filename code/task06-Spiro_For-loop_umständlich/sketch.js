  ...
  let titles = ['Improve coding skills', 'Educate on artificial intelligence', 'title2', 'title3'];
  //titles [zaehler];
...
let div2 = createDiv(titles [1]);
div2.style('font-size', '17px');
div2.style('font-family', 'Trebuchet MS'); 
div2.position(sketchWidth+310, 50+AbstandThema);
  let div2_2 = createDiv("Time spent");
  div2_2.style('font-size', '10px');
  div2_2.style('font-family', 'Trebuchet MS'); 
  div2_2.position(sketchWidth+335, AbstandThema+AbstandThema/2+Abstand*2);
  let div2_3 = createDiv("Specific Topic  <------>   Fundamental Skills");
  div2_3.style('font-size', '10px');
  div2_3.style('font-family', 'Trebuchet MS'); 
  div2_3.position(sketchWidth+335, AbstandThema+AbstandThema/2+Abstand*3);
  let div2_4 = createDiv("Intensity/ Flow/ Concentration");
  div2_4.style('font-size', '10px');
  div2_4.style('font-family', 'Trebuchet MS'); 
  div2_4.position(sketchWidth+335, AbstandThema+AbstandThema/2+Abstand*4)
// Slider Array 2 
//let minValues = [0,1,1]; 
//for (var i = 0; i < 3; i++) {
//  var slider = createSlider(minValues[i], 5, 0); 
//  slider.size(170); 
//  slider.position(sketchWidth+335, AbstandThema*2 +35 + i*Abstand); 
//  Regler.push(slider);    
//}
