...
function setup() {
  ...
  slider1 = createSlider(0, 5, 1, 1); // Slider mit 5 Schritten 
  // Wenn ich später mehrere Slider habe, wie benenne ich sie unterschiedlich? 
  slider1.position(420, 150);
  slider1.size(190);
...
function draw() {
  ...
  drawSpirograph(context, width/2, height/2, // warum funktioniert das mit der Hälfte nicht? (200, 200 geht)
  100, // Radius Kreis Umlaufbahn
